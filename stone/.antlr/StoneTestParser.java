...
public class StoneTestParser extends Parser {
	...
	public StoneTestParser(TokenStream input) {
		super(input);
	...
	public final ProgramContext program() throws RecognitionException {
		...
		try {
			...
			do {
				...
				_errHandler.sync(this);
				_la = _input.LA(1);
			} while ( (((_la) & ~0x3f) == 0 && ((1L << _la) & ((1L << Number) | (1L << Identifier) | (1L << Whitespace) | (1L << Punctuator) | (1L << String))) != 0) );
			}
		}
	...
	public final StatemeContext stateme() throws RecognitionException {
		...
		try {
			...
			setState(9);
			_la = _input.LA(1);
			if ( !((((_la) & ~0x3f) == 0 && ((1L << _la) & ((1L << Number) | (1L << Identifier) | (1L << Whitespace) | (1L << Punctuator) | (1L << String))) != 0)) ) {
	...
	public static final String _serializedATN =
		...
		"\t\3\3\2\6\2\b\n\2\r\2\16\2\t\3\3\3\3\3\3\2\2\4\2\4\2\3\3\2\3\7\2\f\2"+
